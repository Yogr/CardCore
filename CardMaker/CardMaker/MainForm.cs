...
namespace CardMaker
{
    public partial class MainForm : Form
    {
        ...
        private bool _CreateNewMasterFile(string name)
        {
        ...
        {
            ProjectManager.GetInstance().SaveActiveProject();
        }
        ...
        private void FileSaveAs_menuitem_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == result) // Create new file, and save the current data to it
            {
                if (null != mCurrentProjectForm)
                {
                    mCurrentProjectForm.Close();
                ...
                if(_CreateNewMasterFile(newFileName))
                {
                    ProjectManager.GetInstance().SaveActiveProject();
                }
